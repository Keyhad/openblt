...
#define BOOT_COM_NET_IPADDR2              (86)
/** \brief Configure the 4th byte of the IP address */
#define BOOT_COM_NET_IPADDR3              (199)
...
#define BOOT_COM_NET_GATEWAY2             (86)
...
/* If desired, it is possible to set BOOT_FLASH_CUSTOM_LAYOUT_ENABLE to > 0
